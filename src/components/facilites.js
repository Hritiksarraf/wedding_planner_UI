...
export default function Facilites() {
  return (
    ...
    <div className='mt-28 mb-9 flex flex-col item-center justify-center'>
            <h1 className='text-center text-whit text-3xl mb-5' style={{fontFamily:"cursive"}}>Host Your Wedding at the Best Wedding Venue in Bangalore</h1>
            <h2 className='text-center text-2xl px-3  lg:w-2/3 m-auto' style={{fontFamily:"fantasy"}}>FROM GREEN AISLES TO GRANITE ALTERS, FLUID OPEN SPACES, LUSH GREEN LAWNS, HIDDEN NOOKS AND CORNERS FOR INTIMATE CONVERSATIONS TO SPILL OVER.</h2>
            <p className='text-center text-0.5xl px-8 lg:px-2 lg:w-1/2 m-auto my-4' style={{fontFamily:"Bad Script"
...
suited for different celebrations of your event.  Plan each event in a different space as the entire property is given only to one guest and their party! We also have 28 rooms on the property that can accommodate nearly 100 people at once.</p>
      ...
      <div className="mt-28 mb-9 flex flex-col item-center justify-center">
        ...
        <p
          className="text-center text-1xl lg:w-1/3 m-auto my-4 text-gray-500 "
        ...
        >
          ...
          centered around a beautiful koi pond. If you are looking for an
          offbeat location, The Tamarind Tree is one of the best places that
      ...
      <div className="mt-28 mb-9 flex flex-col item-center justify-center">
        ...
        <h2 className="text-center text-2xl" style={{ fontFamily: "fantasy" }}>
          AT THE TOP OPEN AIR WEDDING VENUES IN BANGALORE
        </h2>
        <p
          className="text-center text-1xl lg:w-1/3 m-auto my-4 text-gray-500"
          style={{ fontFamily: "cursive" }}
        >
          ...
          extend the use of our planning and services team to guests. From
          exquisite catering to mesmerizing entertainers, The Tamarind Tree
          strives to make each event one that will go down memory lane.
        </p>
      </div>
      <div className="">
